			...
			>
				...
				<View style={styles.fieldGroup}>
					...
					<TextInput
						...
						placeholder="Ej: Comida, Transporte o Salud"
					...
					<View style={styles.segmentedRow}>
						<Pressable
							style={[
								...
								type === "income" ? styles.segmentButtonActive : undefined,
							]}
						...
						>
							<Text
								style={[
									styles.segmentText,
									type === "income" ? styles.segmentTextActive : undefined,
								]}
							>
								Ingreso
							</Text>
						...
						<Pressable
							style={[
								styles.segmentButton,
								type === "expense" ? styles.segmentButtonActive : undefined,
							]}
						...
						>
							<Text
								style={[
									styles.segmentText,
									type === "expense" ? styles.segmentTextActive : undefined,
								]}
							>
								Egreso
							</Text>
				...
				<View style={styles.fieldGroup}>
					...
					<Text style={styles.helpText}>
						Paleta fija Cashi para reconocer ingresos y egresos al vuelo.
					</Text>
				</View>
