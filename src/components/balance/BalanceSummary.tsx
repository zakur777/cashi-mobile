...
export function BalanceSummary({
	...
	const expenseRatio =
		totalIncome > 0 ? Math.min(totalExpense / totalIncome, 1) : 0;
		...
		<View style={styles.container}>
			...
			>
				...
				<Text style={styles.heroHelp}>
					Calculado desde transacciones locales en CLP, sin decimales.
				</Text>
				...
				<View style={styles.principalCard}>
					<View style={styles.principalTopRow}>
						<View style={styles.principalContent}>
							...
							<Text style={styles.principalName}>
								{primaryExpenseCategory.name}
							</Text>
							<Text style={styles.principalHelp}>
								Mayor gasto del período demo.
							</Text>
						</View>
						<Text style={styles.principalAmount}>
							{formatCLP(primaryExpenseCategory.amount)}
						</Text>
					</View>
					<View style={styles.progressTrack}>
						<GradientSurface
							style={[
								styles.progressFill,
								{ width: `${Math.max(expenseRatio * 100, 8)}%` },
							]}
						/>
					</View>
				</View>
