# Tasks: Visual Parity Follow-up

- [x] 1. Fix fragile Inter import by loading `.ttf` files through `expo-font`.
- [x] 2. Add explicit tab icons for Movimientos, Categorías, and Balance.
- [x] 3. Set Android status bar to light content on dark background.
